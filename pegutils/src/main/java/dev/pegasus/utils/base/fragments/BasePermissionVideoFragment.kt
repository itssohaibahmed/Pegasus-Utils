...
open class BasePermissionVideoFragment : BasePermissionAudioFragment() {
    ...
    protected fun checkVideoStoragePermission(): Boolean {
        val context = context ?: return false
        val permission = getStoragePermissionName()
        return ContextCompat.checkSelfPermission(context, permission) == PackageManager.PERMISSION_GRANTED
    }

    protected fun askVideoStoragePermission(callback: (Boolean) -> Unit) {
