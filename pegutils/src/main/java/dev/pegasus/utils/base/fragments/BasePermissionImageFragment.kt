...
open class BasePermissionImageFragment : BasePermissionVideoFragment() {
    ...
    protected fun checkImageStoragePermission(): Boolean {
        val context = context ?: return false
        val permission = getStoragePermissionName()
        return ContextCompat.checkSelfPermission(context, permission) == PackageManager.PERMISSION_GRANTED
    }

    protected fun askImageStoragePermission(callback: (Boolean) -> Unit) {
